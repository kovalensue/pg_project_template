...
CREATE ROLE my_app;
ALTER ROLE my_app WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOREPLICATION NOBYPASSRLS;
CREATE ROLE my_app_replica;
ALTER ROLE my_app_replica WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN REPLICATION NOBYPASSRLS;
...
--
-- Name: my_app; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE my_app WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE my_app OWNER TO postgres;
...
--
-- Name: my_app_pub; Type: PUBLICATION; Schema: -; Owner: postgres
--

CREATE PUBLICATION my_app_pub WITH (publish = 'insert, update, delete, truncate');


ALTER PUBLICATION my_app_pub OWNER TO postgres;

--
-- Name: my_app_pub test_table; Type: PUBLICATION TABLE; Schema: public; Owner: postgres
--

ALTER PUBLICATION my_app_pub ADD TABLE ONLY public.test_table;
...
--
-- Name: my_app; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA my_app;


ALTER SCHEMA my_app OWNER TO postgres;
